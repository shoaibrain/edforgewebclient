 ...
 * 
 * Comprehensive classroom details page with role-based UI/UX.
 * Provides different views and controls based on user role and permissions.
 */
	...
	useEffect(() => {
		if (classroomId) {
			...
			if (classroomData) {
				...
				setEnrollments(getEnrollmentsByClassroom(classroomId));
				const analyticsData = getClassroomAnalytics(classroomId);
				setAnalytics(analyticsData || null);
			} else {
				// Classroom not found, redirect to classes page
				router.push("/dashboard/curriculum/classes");
			}
		}
	}, [classroomId, router]);
		...
		return (
			<div className="flex flex-1 flex-col items-center justify-center p-6">
				<div className="text-center">
					...
					<h2 className="text-xl font-semibold mb-2">Loading Classroom...</h2>
					<p className="text-muted-foreground">Please wait while we load the classroom details.</p>
				</div>
			</div>
		);
	}
			...
			<div className="flex-1 bg-background">
				...
				<div className="max-w-7xl mx-auto px-6 py-6">
										...
										<Dialog>
											...
											<DialogContent className="sm:max-w-[425px]">
												...
												<div className="grid gap-4 py-4">
													...
													<div className="grid grid-cols-4 items-center gap-4">
														<Label htmlFor="teacher-role" className="text-right">
															Role
														</Label>
														<Input
															id="teacher-role"
															placeholder="Teacher, Co-Teacher, etc."
															className="col-span-3"
														/>
													</div>
												</div>
								...
								<Card>
									<CardContent className="p-6">
										<div className="flex items-center gap-4">
											...
											<div className="flex-1">
												<h3 className="font-semibold text-lg">{classroom.primaryTeacher.teacherName}</h3>
										...
										<Dialog>
											...
											<DialogContent className="sm:max-w-[425px]">
												<DialogHeader>
													...
													<DialogDescription>
														Add new students to this classroom. You can enter multiple email addresses separated by commas.
													</DialogDescription>
												</DialogHeader>
												<div className="grid gap-4 py-4">
													<div className="grid grid-cols-4 items-center gap-4">
														<Label htmlFor="student-emails" className="text-right">
															Emails
														</Label>
														<Input
															id="student-emails"
													...
													<div className="grid grid-cols-4 items-center gap-4">
														<Label htmlFor="student-message" className="text-right">
															Message
														</Label>
														<Input
															id="student-message"
								...
								{enrollments.length > 0 ? (
												...
												<CardContent className="p-4">
													<div className="flex items-center gap-3">
														...
														<div className="flex-1 min-w-0">
															<h4 className="font-medium text-sm truncate">{enrollment.studentName}</h4>
															<p className="text-xs text-muted-foreground">{enrollment.grade}</p>
														</div>
														<Button variant="ghost" size="sm">
															<MoreHorizontal className="h-4 w-4" />
														</Button>
									...
									<Card>
										<CardContent className="p-8 text-center">
											...
											<p className="text-muted-foreground">Invite students to join your classroom.</p>
										</CardContent>
									</Card>
								)}
							</div>
					...
					{activeTab === "grades" && (
						<div className="space-y-6">
							<div className="flex items-center justify-between">
								<h2 className="text-xl font-semibold text-foreground">Grade Configuration</h2>
								{canManageGrades && (
									<Button>
										<Plus className="h-4 w-4 mr-2" />
										Add Assignment
							...
							<Card className="bg-card border-border">
								<CardHeader>
									...
									<CardDescription>
										Configure how grades are calculated and displayed for this classroom.
									</CardDescription>
								</CardHeader>
								<CardContent className="space-y-6">
									<div className="grid gap-4 md:grid-cols-2">
										<div className="space-y-2">
											...
											<Input id="grading-scale" placeholder="A, B, C, D, F" />
										</div>
										<div className="space-y-2">
											<Label htmlFor="passing-grade">Passing Grade (%)</Label>
											<Input id="passing-grade" type="number" placeholder="60" />
										</div>
									</div>
									<div className="space-y-2">
										<Label htmlFor="grade-weights">Assignment Categories & Weights</Label>
										<div className="space-y-3">
											<div className="flex items-center gap-4">
												<Input placeholder="Homework" className="flex-1" />
											...
											<div className="flex items-center gap-4">
												<Input placeholder="Quizzes" className="flex-1" />
												<Input placeholder="20%" className="w-20" />
												<Button variant="ghost" size="sm">
													<Minus className="h-4 w-4" />
												</Button>
											</div>
											<div className="flex items-center gap-4">
												<Input placeholder="Exams" className="flex-1" />
												<Input placeholder="50%" className="w-20" />
												<Button variant="ghost" size="sm">
													<Minus className="h-4 w-4" />
												</Button>
											</div>
						...
						<div className="space-y-6">
									...
									<CardContent className="p-6">
										<div className="flex items-center gap-4">
											...
											<div>
												...
												<p className="text-2xl font-bold text-primary">{analytics?.averageGrade || 0}%</p>
											</div>
										</div>
									</CardContent>
								</Card>
									...
									<CardContent className="p-6">
										<div className="flex items-center gap-4">
											...
											<div>
												...
												<p className="text-2xl font-bold text-blue-500">{analytics?.attendanceRate || 0}%</p>
											</div>
										</div>
									</CardContent>
								</Card>
									...
									<CardContent className="p-6">
										<div className="flex items-center gap-4">
											...
											<div>
												...
												<p className="text-2xl font-bold text-purple-500">{analytics?.engagementScore || 0}%</p>
											</div>
										</div>
									</CardContent>
								</Card>
							...
							<Card className="bg-card border-border">
								<CardHeader>
									...
									<CardDescription>Key metrics and trends for this classroom</CardDescription>
								</CardHeader>
								<CardContent>
									<div className="text-center py-12">
										<BarChart2 className="mx-auto h-12 w-12 text-muted-foreground mb-4" />
										<h3 className="text-lg font-semibold text-foreground">Detailed Analytics Coming Soon</h3>
										<p className="text-muted-foreground">Performance charts and detailed insights will be available here.</p>
									</div>
								</CardContent>
							</Card>
						</div>
